...
export default function home() { 
  return (
    <div className="flex justify-center w-[100%] h-[100%] bg-[#ecf39e] p-11 flex-wrap">
      <div className="rotate-center  w-[250px] sm:w-[250px] md:w-[250px] lg:w-[250px]  h-[300px] sm:h-[300px] md:h-[300px] lg:h-[300px] bg-[#31572c] sm:bg-[#31572c] md:bg-[#31572c] lg:bg-[#31572c]  rounded-xl shadow-xl m-3 relative">
